...
public class CartItemController
{
	...
	@RequestMapping(value = "/all/orderdetails")
	public String history(Model model, @AuthenticationPrincipal Principal principal) 
	{
		String email = principal.getName();
		List<CustomerOrder> customerorder = cartItemDao.History(email);
		model.addAttribute("customerorder", customerorder);
		return "orderHistory";
