			...
			<div class="row">
				<div class="col-xs-12">
					<div class="invoice-title">
						<h2>Invoice</h2>
						<h3 class="pull-right">Order # ${customerOrder.orderId }</h3>
					</div>
					<hr>
					<div class="row">
						<div class="col-xs-6">
							<address>
								...
								${customerOrder.user.customer.billingAddress.country}
							</address>
						</div>
						<div class="col-xs-6 text-right">
							<address>
								...
								${customerOrder.user.customer.shippingAddress.zipcode}<br>
								${customerOrder.user.customer.shippingAddress.state} -
								${customerOrder.user.customer.shippingAddress.country}
							</address>
						</div>
					</div>
					<div class="row">
										...
										<c:forEach items="${cartItems}" var="cartItem">
											...
											<tr>
												<c:url value="/resources/images/${cartItem.product.id }.png"
													var="imgUrl"></c:url>
												<td><img src="${imgUrl }" height="80px" width="80px">
												</td>
